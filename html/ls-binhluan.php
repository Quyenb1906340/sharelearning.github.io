                                                                                     ...
                                                                                     if (mysqli_num_rows($result_nguoi_dung) > 0) {
                                                                                          foreach ($grouped_articles as $date => $articles) {
                                                                                               ...
                                                                                               foreach ($articles as $key => $article) {
                                                                                                    ...
                                                                                                    echo '        <a href="#" onclick="Xoa_Binhluan('. $article['bl_ma'] .');" class="dt-button buttons-csv buttons-html5 dropdown-item" type="button">';
        ...
        function Xoa_Binhluan(bl_ma) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'xoa_binhluan.php?bl_ma=' + bl_ma;
                }
            });
        }
    </script>
