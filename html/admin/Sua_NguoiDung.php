                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input name="name" type="text" class="form-control"
                                                        ...
                                                        value="<?php echo $row_nguoi_dung['nd_hoten']; ?>" required/>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input name="email" type="text" id="basic-icon-default-email"
                                                        ...
                                                        value="<?php echo  $row_nguoi_dung['nd_email']; ?>" required/>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input name="phone" type="text" id="basic-icon-default-phone"
                                                        ...
                                                        value="<?php echo  $row_nguoi_dung['nd_sdt']; ?>" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input name="address" type="text" id="basic-icon-default-phone"
                                                        ...
                                                        aria-describedby="basic-icon-default-phone2"
                                                        value="<?php echo  $row_nguoi_dung['nd_diachi']; ?>" required/>
                                                </div>
                                            </div>
