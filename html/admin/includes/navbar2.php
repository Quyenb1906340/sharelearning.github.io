                            ...
                            <button name="chitiet_bl" class="dropdown-item">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class=" mb-0 text-container"> Đã bình luận bài viết
                                            "<i><b><?php echo $tb['tieude']; ?></b></i>": <?php echo $tb['nd_bl']; ?>
                                        </p>
                            ...
                            <button name="chitiet_bv" class="dropdown-item">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class=" mb-0 text-container"> Đã đăng bài viết
                                            "<i><b><?php echo $tb['tieude']; ?></b></i>"</p>
                                        <small class="text-muted">
                                            <?php  
                                                                    // Lấy thời gian của bài viết và thời gian hiện tại
                                                                    $commentDate = strtotime($tb['ngaydang']);
                            ...
                            <button style="color: #aaaaaa " name="chitiet_bl" class="dropdown-item">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 style="color: #aaaaaa " class="mb-1 text-container">
                                            <?php echo $tb['hoten']; ?></h6>
                                        <p class=" mb-0 text-container"> Đã bình luận bài viết
                                            "<i><b><?php echo $tb['tieude']; ?></b></i>": <?php echo $tb['nd_bl']; ?>
                                        </p>
                                        <small class="text-muted">
