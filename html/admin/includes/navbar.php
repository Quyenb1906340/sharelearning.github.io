...
<nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <div class="navbar-nav align-items-center">
            <div class="nav-item d-flex align-items-center">
                ...
                <input id="searchInput" type="text" class="form-control border-0 shadow-none" placeholder="Tìm kiếm..."
                    aria-label="Tìm kiếm..." />
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li class="nav-item navbar-dropdown dropdown-notification dropdown me-4">
                ...
                <ul style="width:350px; height: 400px" class="dropdown-menu dropdown-menu-end notification-scroll"
                    data-bs-popper="static">
                    <form method="POST">
                        <li>
                            <div class="dropdown-header d-flex align-items-center py-3">
                                <h5 class="text-body mb-0 me-auto">Thông báo</h5>
                                <button name="doc_tatca" style="border: none; background-color: white"
                                    href="javascript:void(0)" class="dropdown-notifications-all text-body"
                                    data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Đánh dấu đã đọc"
                                    data-bs-original-title="Đánh dấu đã đọc"><i
                            ...
                            <button name="chitiet_bl" class="dropdown-item">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar ">
                                            <img src="assets/img/avatars/<?php echo $tb['hinh']; ?>" alt
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class=" mb-0 text-container">Đã bình luận bài viết "<i><b><?php echo $tb['tieude']; ?></b></i>": <?php echo $tb['nd_bl']; ?>
                                        </p>
                                    ...
                                    <span><i style="font-size: 10px; color:#696cff" class="fa fa-circle"
    ...
    <div class="position-fixed top-0 end-0" style="z-index: 11; margin-top:75px">
        <div id="thongbao_thucthi" class="toast hide <?php echo $_SESSION['bg_thongbao']; ?>" role="alert"
            aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                <!-- <span><i class="fa-solid fa-circle-check fa-lg"> </i> &nbsp; </span> -->
                <strong class="me-auto"><?php echo $_SESSION['thongbao_thucthi']; ?></strong>
