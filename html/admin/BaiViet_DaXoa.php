    ...
    if ($selectedAction == 'phuchoi') {
        ...
        try {
            foreach ($selectedIds as $bv) {
                ...
                if($row_kt['ghi_chu'] == 1){
                    $gc = "Đã duyệt";
                }elseif($row_kt['ghi_chu'] == 2){
                    $gc = "Đã huỷ";
                }elseif($row_kt['ghi_chu'] == 3){
                    $gc = "Chờ duyệt";
                }
            ...
            $_SESSION['bg_thongbao'] = "bg-success";
            $_SESSION['thongbao_thucthi'] = "Bạn đã khôi phục dữ liệu thành công!";
...
<body>
                                        ...
                                        <tbody class="table-border-bottom-0" id="data-container">
                                            ...
                                            <tr>
                                                ...
                                                <td style="white-space: normal">
                                                    <?php echo date_format(date_create($row_bai_viet['thoigian']), "d-m-Y (H:i:s)"); ?>
                                                <td style="white-space: normal">
    ...
    <script>
    // JavaScript để thực hiện chức năng tìm kiếm
