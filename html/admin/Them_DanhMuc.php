                                        ...
                                        <form method="POST" enctype="multipart/form-data">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input required name="dm_ten" type="text" class="form-control"
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="basic-icon-default-fullname">Danh mục cha</label>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="basic-icon-default-fullname">Danh mục con</label>
