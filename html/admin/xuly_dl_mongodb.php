...
foreach ($invertedIndex as $word => $docEntries) {
 ...
 // Tạo bảng chimuctieude
    ...
    // Kiểm tra xem đã có đường dẫn trước đó hay chưa
    if(isset($_SERVER['HTTP_REFERER'])) {
        ...
        // Nếu không có đường dẫn trước đó, có thể thực hiện một hành động khác hoặc chuyển hướng về một trang mặc định
        header('Location: /default-page.php');
        exit;
    }
    // header("Location: KiemDuyet.php");
