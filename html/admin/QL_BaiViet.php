        ...
        try {
            foreach ($selectedIds as $id) {
                ...
                if($row_kt && $bv == $row_kt['bv_ma']){
                    ...
                    $xoa_bai_viet = "INSERT INTO kiem_duyet (bv_ma, nd_username, tt_ma, thoigian, ghi_chu) VALUE ('$bv', '$user', '$selectedAction', now(), '$tt') ";
            ...
            $_SESSION['thongbao_thucthi'] = "Bạn đã xóa dữ liệu thành công! '$tt'";
...
elseif($_SESSION['vaitro'] == 'Admin'){
    if ($trangthai == "3") {
        ...
        $bai_viet = "SELECT a.*, e.*,c.tt_ma, c.ghi_chu, d.*,b.dm_ten,f.nd_username as quanly 
                        FROM bai_viet a
                        LEFT JOIN nguoi_dung e ON a.nd_username=e.nd_username
                        LEFT JOIN kiem_duyet c ON c.bv_ma = a.bv_ma
                        LEFT JOIN trang_thai d ON c.tt_ma = d.tt_ma 
                        ...
                        <div class="card">
                            ...
                            <div class="row card-header d-flex flex-wrap py-3 px-3 justify-content-between">
                                ...
                                <div style="padding-left:10px"
                                    ...
                                    <a href="Thembv.php" class="dt-button add-new btn btn-primary" type="button">
                                        <span>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch mb-2">
                                                        <input name="an-hien"
                                                            ...
                                                            onchange="changePostState(this)"
                                                            <?php if( $row_bai_viet['ghi_chu'] == '5' ){ echo "checked";}else{} ?>
