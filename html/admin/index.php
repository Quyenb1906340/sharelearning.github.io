                                                    ...
                                                    <li class="d-flex mb-4">
                                                        <div
                                                            ...
                                                            <div style="text-align: left " class="me-2 col-lg-6">
                                                                <a href="Xem_BaiViet.php?this_bv_ma=<?php echo $row_top_danhgia['bv_ma']; ?>&tg=<?php echo $row_top_danhgia['nd_username']; ?>"><h6 style="text-align: left" class="mb-0">
                                                                    <?php echo $row_top_danhgia['bv_tieude']?></h6></a>
                                                ...
                                                ?>
                                                        <li class="d-flex mb-4">
                                                            <div
                                                                class="d-flex w-100 flex-wrap justify-content-between gap-2">
                                                                <div style="text-align: left " class="me-2 col-lg-6">
                                                                <a href="Xem_BaiViet.php?this_bv_ma=<?php echo $row_top_binhluan['bv_ma']; ?>">
