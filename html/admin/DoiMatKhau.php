                                ...
                                <form enctype="multipart/form-data" id="formAccountSettings" method="POST"
                                        ...
                                        <div class="mb-3 col-md-6 form-password-toggle fv-plugins-icon-container">
                                            ...
                                            <div class="input-group input-group-merge has-validation">
                                                <input class="form-control" type="password" name="MK_Hientai"
                                                    id="currentPassword" placeholder="Nhập mật khẩu hiện tại" required>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6 form-password-toggle fv-plugins-icon-container">
                                            ...
                                            <div class="input-group input-group-merge has-validation">
                                                <input class="form-control" type="password" id="MK_Moi" name="MK_Moi"
                                        ...
                                        <div class="col-12 mt-1">
                                            <button name="Luu" type="submit" class="btn btn-primary me-2">Lưu thay
                                                đổi</button>
