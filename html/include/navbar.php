...
<nav style=" background-color: #12486B; height:57px" class="navbar navbar-expand-lg  navbar-dark mb-5 fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5" href="index.php"><img width="150px" src="../assets/img/favicon/logo2.png" alt=""></a>
    ...
    <style>
      ...
      #overlay {
        ...
        z-index: 1000;
        /* Adjust the z-index to make sure it overlays other elements */
      }
    ...
    <ul class="navbar-nav me-auto mb-2  ms-4 mb-lg-0">
      ...
      <li class="nav-item dropdown me-3">
        ...
        <a style="font-size:17px" href="#" id="menu" class="nav-link dropdown-toggle text-white" data-bs-toggle="dropdown" data-bs-display="static">Khối lớp</a>
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li>
              <a onclick="logout()" href="#" class="dropdown-item">
                ...
                <span style="margin-right: 100px;">Đăng Xuất</span>
              </a>
            </li>
          </ul>
        <?php } else { ?>
          <ul class="navbar-nav mb-2 mb-lg-0">
            <li> <a data-bs-toggle="modal" data-bs-target="#modalCenter" class="nav-link align-middle" href="">Login</a></li>
          </ul>
        <?php } ?>
        </li>
      </ul>
...
<div class="position-fixed top-0 end-0 " style="z-index: 11; margin-top:70px">
  <div id="loginFailedToast" class="toast hide bg-danger" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="toast-header">
      ...
      <strong class="me-auto"> Đăng nhập thất bại. Vui lòng kiểm tra lại thông tin đăng nhập!</strong>
      <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="index.php" method="post">
            <div class="row">
              <div class="col mb-3">
                <label for="nameWithTitle" class="form-label"><b>Tên Đăng Nhập</b></label><span style="color: red;font-weight: bold;"> *</span>
            ...
            <div class="row">
              ...
              <div class="col mb-3">
                <label for="nameWithTitle" class="form-label"><b>Mật Khẩu</b></label><span style="color: red;font-weight: bold;"> *</span>
                <input name="matkhau" type="password" class="form-control" placeholder="Nhập mật khẩu" required/>
              </div>
