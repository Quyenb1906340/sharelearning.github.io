...
<aside style="z-index: 1;" id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme mt-2">
  ...
  <ul class="menu-inner py-1">
    ...
    <div class="form-check mt-3 ">
       ...
       <a href="index.php"> <label class="form-check-label" >Tất cả bài viết <?php  
       
         $sl = "SELECT  count(*) as tong FROM bai_viet b
                   
                   LEFT join kiem_duyet k On b.bv_ma = k.bv_ma
                   WHERE  k.tt_ma = '1' AND (k.ghi_chu != 5 OR k.ghi_chu IS NULL)";

         $result_sl = mysqli_query($conn,$sl);
        ...
        <div class="form-check mt-3 ">
           ...
           <?php
                $sl_kl = "SELECT l.kl_ma, count(*) as tong FROM khoi_lop l
                          ...
                          LEFT join kiem_duyet k On b.bv_ma = k.bv_ma
                          WHERE l.kl_ma='".$khoilop['kl_ma']."' and k.tt_ma = '1' AND (k.ghi_chu != 5 OR k.ghi_chu IS NULL)";
