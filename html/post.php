                    ...
                    if (isset($_SESSION['bv'])) {
                      $bv = $_SESSION['bv'];
                                        ...
                                        <a href="Xem_BaiViet.php?id=<?php echo $username ?>&bv=<?php echo $bv ?>">
                                            <div id="dangbai" class="toast hide bg-warning" role="alert"
                                                aria-live="assertive" aria-atomic="true">
                                                <div class="toast-header">
                                                    <strong class="me-auto">Đăng bài thành công vui lòng chờ
                                                        duyệt!</strong>
                                    ...
                                    <form class="needs-validation" method="post" action="dangbai.php"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            .resultBox {
                                                ...
                                                max-height: 180px;
                                                /* Set a maximum height for the scroll bar */
                                                overflow-y: auto;
                                            }
                                            </style>
                                            <?php
                      ...
                      ?>
                                            ...
                                            document.addEventListener("DOMContentLoaded", function() {
                                                ...
                                                document.addEventListener("click", function(event) {
                                                    var isClickedInsideResultBox = event.target.closest(
                                                        '#checkResult');
                        ...
                        ?>
                                        ...
                                        <button type="submit" id="runPythonBtn" name="gui" class="btn btn-primary">Đăng
                                            Bài</button>
