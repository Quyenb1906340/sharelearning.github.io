            ...
            <div class="row">
              <div class="col-md-12">
                <div class="row">
                  ...
                  <?php
                  $id = $_GET['id'];
                  $sql = " SELECT bv.*,nd.*,trangthai, dm_ten, mh_ten, kl_ten,CURRENT_TIMESTAMP(), COALESCE(slbl, 0) AS slbl
                  FROM bai_viet bv
                  LEFT JOIN (
                      ...
                      <div class="card-body">
                        <nav aria-label="breadcrumb">
                          <ol class="breadcrumb breadcrumb-style1">
                            ...
                            <li class="breadcrumb-item">
                              <a href="javascript:void(0);"><?php echo $baiviet['mh_ten'] ?></a>
                            </li>
                            <li class="breadcrumb-item active"><?php echo $baiviet['dm_ten'] ?></li>
                          </ol>
                        </nav>
                        <div class="d-flex">
                        ...
                        <div>
                          ...
                          while ($tailieu = mysqli_fetch_array($result)) {
                            ...
                            } elseif (in_array(strtolower($duoi_tai_lieu), ['jpg', 'png', 'jpeg'])) {
                              $icon = '<i class="fa-solid fa-file-image" style="color: blue;"></i>'; // Change color of image file icon to blue
                            } else {
                              $icon = '<i class="fa-solid fa-file" style="color: #70b1cd;"></i>';
                            }
