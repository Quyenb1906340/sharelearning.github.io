...
if (isset($_POST['gui'])) {
    ...
    $pythonScript4 = "C:/xampp/htdocs/VnCoreNLP-master/tachcau.py";
    $pythonScript5 = "C:/xampp/htdocs/VnCoreNLP-master/tachtucau.py";

    $command = "python $pythonScript";
    $command2 = "python $pythonScript2";
    $command3 = "python $pythonScript3";
    $command4 = "python $pythonScript4";
    $command5 = "python $pythonScript5";

    exec($command, $output, $return_var);
    exec($command2, $output, $return_var);
    exec($command3, $output, $return_var);
    exec($command4, $output, $return_var);
    exec($command5, $output, $return_var);
