  ...
  $selectedIds = isset($_POST['check']) ? $_POST['check'] : [];
    try {
        foreach ($selectedIds as $bv) {
                ...
                $kt_ls="select *from lich_su_xem where bv_ma = '$bv'";
                ...
                $kt="select *from binh_luan where bv_ma = '$bv'";
                ...
                $delete_query = "DELETE FROM danh_gia WHERE bv_ma = '$bv'";
                mysqli_query($conn, $delete_query);

                $delete_query = "DELETE FROM binh_luan WHERE bv_ma = '$bv'";
                mysqli_query($conn, $delete_query);
