...
<body>
                            ...
                            <div class="mb-4 col-10">
                                ...
                                <form action="index.php" method="get">
                                    <div style="width:30rem" class="list-group list-group-horizontal-md text-md-center">
                                        ...
                                        <a id="newestTab" style="border: 1px solid;" class="list-group-item list-group-item-action " data-bs-toggle="list" href="#horizontal-home" onclick="changeLocation('newest', 'newestTab')"><b>Mới
                                                nhất</b></a>
                                        <a id="ratingTab" style="border: 1px solid;" class="list-group-item list-group-item-action" data-bs-toggle="list" href="#horizontal-profile" onclick="changeLocation('rating', 'ratingTab')"><b>Đánh giá</b></a>
                                        <a id="commentsTab" style="border: 1px solid;" class="list-group-item list-group-item-action" data-bs-toggle="list" href="#horizontal-messages" onclick="changeLocation('comments', 'commentsTab')"><b>Bình luận</b></a>
                                        <a id="viewsTab" style="border: 1px solid;" class="list-group-item list-group-item-action" data-bs-toggle="list" href="#horizontal-settings" onclick="changeLocation('views', 'viewsTab')"><b>Lượt xem</b></a>
    ...
    left join danh_gia dg on bv.bv_ma = dg.bv_ma
            WHERE kd.tt_ma = 1 AND (kd.ghi_chu != 5 OR kd.ghi_chu IS NULL) and bv.dm_ma IN ($danhMucString) AND bv.bv_ma NOT IN ($bvString)
            GROUP BY bv.bv_ma 
    ...
    LEFT JOIN kiem_duyet kd on kd.bv_ma = bv.bv_ma
    left join danh_gia dg on bv.bv_ma = dg.bv_ma
    WHERE kd.tt_ma = 1  AND (kd.ghi_chu != 5 OR kd.ghi_chu IS NULL) and kl.kl_ma = $khoilop
    GROUP BY bv.bv_ma
    ";
  ...
  LEFT JOIN kiem_duyet kd on kd.bv_ma = bv.bv_ma
  left join danh_gia dg on bv.bv_ma = dg.bv_ma
  WHERE kd.tt_ma = 1  AND (kd.ghi_chu != 5 OR kd.ghi_chu IS NULL) and mh.mh_ma = $monhoc
  GROUP BY bv.bv_ma
  ";
                                            if (isset($_GET['loc']) && !empty($_GET['loc'])) {
                                                $loc = $_GET['loc'];
  ...
  LEFT JOIN kiem_duyet kd on kd.bv_ma = bv.bv_ma
  left join danh_gia dg on bv.bv_ma = dg.bv_ma
  WHERE kd.tt_ma = 1  AND (kd.ghi_chu != 5 OR kd.ghi_chu IS NULL) and dm.dm_ma = $danhmuc
  GROUP BY bv.bv_ma
  ";
                                            if (isset($_GET['loc']) && !empty($_GET['loc'])) {
                                                $loc = $_GET['loc'];
                                            ...
                                            LEFT JOIN binh_luan bl ON bv.bv_ma = bl.bv_ma 
                                            LEFT JOIN danh_gia dg ON bv.bv_ma = dg.bv_ma
                                            where kd.tt_ma = 1   AND (kd.ghi_chu != 5 OR kd.ghi_chu IS NULL)  GROUP BY 
                                            bv.bv_ma
                                            ";
                                            if (isset($_GET['loc']) && !empty($_GET['loc'])) {
                                                $loc = $_GET['loc'];
                                    ...
                                    <img src="../assets/img/avatars/<?php echo $row['nd_hinh'] ?>" alt="google" class="me-3 rounded-circle" height="40" />
                                                                    ...
                                                                    <div class="flex-grow-1 row">
                                                                        <div class="col-12 mb-sm-0 mb-2">
                                                                            <h4 style="color:#1774af" class="mb-0  "><b>
                                                                                    <?php echo $row['bv_tieude'] ?></b></h4>
                                                                            <br>

                                                                            <small class="text-dark">Tác giả: <b>
                                                                                    <?php echo $row['nd_hoten'] ?></b></small>
                                                                            <br>
                                                                            <small class="text-dark">Lớp:
                                                                                <?php echo $row['kl_ten'] ?></small> <br>
                                                                            <small class="text-dark">Môn:
                                                                                <?php echo $row['mh_ten'] ?></small> <br>
                                                                            <?php
                                        ...
                                        ";
                                                                            ...
                                                                            <small class="text-dark"><em> Tag:
                                                                                    <?php echo $row['dm_ten'] ?> <?php while ($tag = mysqli_fetch_array($resulttag)) {
                                                                                                                        echo ', ' . $tag['dm_ten'] . '';
                                                                                                                    } ?>
                                                                                </em></small>

                                                                            <br>
                                                                            <small class="text-dark"><i class="fa-solid fa-calendar-days"></i>
                                                                                <?php echo $timeAgo ?> </small> &nbsp;
                                                                            <small class="text-dark"><i class="fa-solid fa-star" style="color: #FDCC0D;"></i>
                                                                                <?php echo $row['bv_diemtrungbinh']  ?></small>
                                                                            &nbsp;
                                                                            <small class="text-dark"> <i class="fa-solid fa-eye"></i>
                                                                                <?php echo $row['bv_luotxem'] ?></small> &nbsp;
                                                                            <small class="text-dark"> <i class="fa-solid fa-comment"> </i>
                                                                                <?php echo $row['slbl'] ?></small>
                                                                        </div>
